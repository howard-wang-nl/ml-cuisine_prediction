...
/**
 * Cuisine prediction using decision trees and random forests.
 *
...
object CuisinePrediction {
  ...
  def main(args: Array[String]) {
    ...
    val parser = new OptionParser[Params]("CuisinePrediction") {
      head("CuisinePrediction: an example decision tree app.")
      opt[String]("algo")
  ...
  private[mlx] def meanSquaredError(
